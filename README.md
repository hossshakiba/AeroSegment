...
<img style="width: 70%; height: auto;" src="assets/u-net-architecture.png"/>
</p>
...
<p class="row" float="left" align="middle">
<img style="width: 70%; height: auto;" src="assets/cbam.png"/>
</p>
...
### Results
We evaluated our model using Pixel Accuracy (PA) and Mean Intersection over Union (MIoU) metrics. The model achieved an impressive **86.66%** PA and demonstrated a significant MIoU score of **0.5333**, underscoring its proficiency in semantic segmentation. To further illustrate the effectiveness of our model, we present visual comparisons between its segmentation results and the corresponding ground truth labels. You can explore a selection of our model's segmentation results within the [results](results) folder of this repository.
<p class="row" float="left" align="middle">
<img style="width: 100%; height: auto;" src="assets/results.gif"/>
</p>
